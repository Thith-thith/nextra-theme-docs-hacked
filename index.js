...
function Navbar({ flatDirectories, items }) {
  ...
  return /* @__PURE__ */ React8.createElement(React8.Fragment, null, /* @__PURE__ */ React8.createElement("script", {
    ...
    return /* @__PURE__ */ React8.createElement(Link3, {
      ...
      className: cn3("nextra-nav-link", " no-underline whitespace-nowrap mr-4 hidden md:inline-block", isActive ? "active font-bold text-selendra" : "text-gray-500"),
      "aria-selected": isActive
    }, page.newWindow ? { target: "_blank", rel: "noopener noreferrer" } : {}), page.title));
  }) : null, /* @__PURE__ */ React8.createElement("div", {
    className: "flex-1"
  }, /* @__PURE__ */ React8.createElement("div", {
...
var NextLink = ({ route, title, isRTL }) => {
  return /* @__PURE__ */ React17.createElement(Link4, {
    ...
    className: cn5("w-full text-lg font-medium p-4 -m-4 no-underline transition-colors text-gray-600 dark:text-gray-300 dark:hover:text-primary-500 hover:text-primary-500 inline-flex items-center justify-end rounded", { "ml-2": !isRTL, "mr-2": isRTL }),
    title
...
var PrevLink = ({ route, title, isRTL }) => {
  return /* @__PURE__ */ React17.createElement(Link4, {
    ...
    className: cn5("text-lg font-medium p-4 -m-4 no-underline transition-colors text-gray-600 dark:text-gray-300 dark:hover:text-primary-500 hover:text-primary-500 flex items-center rounded", { "mr-2": !isRTL, "ml-2": isRTL }),
    title
...
function Sidebar({
  ...
  return /* @__PURE__ */ React24.createElement("aside", {
    className: cn8("sidebar-lelf nextra-sidebar-container nextra-scrollbar fixed flex-shrink-0 w-full md:w-64 md:sticky z-[15] top-16 self-start overflow-y-auto transform-none h-[calc(100vh-4rem)] ", asPopover ? "md:hidden" : "md:block", hasMenu ? "with-menu" : "", { open: menu })
...
function ToC({
  ...
  return /* @__PURE__ */ React25.createElement("div", {
    className: "sidebar-right nextra-toc w-64 hidden xl:block text-sm px-4"
...
function Breadcrumb({ activePath }) {
  return /* @__PURE__ */ React27.createElement("div", {
    ...
    return /* @__PURE__ */ React27.createElement(React27.Fragment, {
      key: item.route
    }, index ? /* @__PURE__ */ React27.createElement("span", {
...
var Body = ({
  ...
  return /* @__PURE__ */ React28.createElement(React28.Fragment, null, /* @__PURE__ */ React28.createElement(SkipNavContent, null), themeContext.layout === "full" ? /* @__PURE__ */ React28.createElement("article", {
    className: cn11("nextra-body full relative overflow-x-hidden", !themeContext.sidebar ? "expand" : "")
  }, /* @__PURE__ */ React28.createElement(MDXTheme, null, children)) : themeContext.layout === "raw" ? /* @__PURE__ */ React28.createElement("div", {
    className: "nextra-body full relative overflow-x-hidden expand"
  }, children) : /* @__PURE__ */ React28.createElement("article", {
    className: cn11("nextra-body relative pb-0 w-full max-w-full flex min-w-0 pr-[calc(env(safe-area-inset-right)-1.5rem)]", themeContext.typesetting ? "nextra-body-typesetting-" + themeContext.typesetting : "")
  }, /* @__PURE__ */ React28.createElement("main", {
    className: "responsive-layout mx-auto z-10 min-w-0 w-full "
    ...
    className: "text-xs text-right block text-gray-500 mt-12 mb-8 dark:text-gray-400 pointer-default hidden"
...
var Content = ({
  ...
  return /* @__PURE__ */ React28.createElement(React28.Fragment, null, /* @__PURE__ */ React28.createElement(Head, {
    ...
    toc: activeType === "page" || !themeContext.toc ? activeType === "page" || hideSidebar ? null : /* @__PURE__ */ React28.createElement("div", {
      className: "nextra-toc w-64 hidden xl:block text-sm px-4"
...
var src_default = (opts, _config) => {
  ...
  if (!GlobalLayout) {
    GlobalLayout = function({
      ...
      }), /* @__PURE__ */ React28.createElement(Content, __spreadValues({}, opts2), children)));
    };
  }
  ...
  Page.withLayout = (page) => {
    return /* @__PURE__ */ React28.createElement(GlobalLayout, {
      opts,
